...
The private positive-token gate is blocked because the documented existing
operator-token file is unavailable. No token rotation or relay change was
performed. GitHub CI and live Phase 2 consumer verification remain pending;
